...
namespace Fenco.Areas.admin.Controllers
{
    ...
    public class SettingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Logo1,Logo2,Address,Phone,Email,Map")] Setting setting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Logo1,Logo2,Address,Phone,Email,Map")] Setting setting)
        {
            if (id != setting.Id)
            {
                return NotFound();
