...
namespace Fenco.Areas.admin.Controllers
{
    ...
    public class SocialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Icon,Link")] Social social)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Icon,Link")] Social social)
        {
            if (id != social.Id)
            {
                return NotFound();
